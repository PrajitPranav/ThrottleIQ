      ...
      child: Column(
        children: [
          ...
          Row(
            mainAxisAlignment: MainAxisAlignment.spaceBetween,
            children: [
              _metric('Distance', trip.distanceKm.toStringAsFixed(1), 'KM'),
              _metric('Duration', '${trip.durationMinutes}m', ''),
              _metric('Avg Spd', trip.averageSpeedKmh.toStringAsFixed(0), 'KM/H'),
              _metric('Top Spd', trip.topSpeedKmh.toStringAsFixed(0), 'KM/H'),
            ],
          ),
        ],
      ),
